<?php
    ...
    $select = mysql_query("SELECT * FROM `data_component` WHERE `component_structure` LIKE '$structure' OR `component_structure` LIKE '$structure1' OR `component_structure` LIKE '$structure2' OR `component_structure` LIKE '$structure3'");
